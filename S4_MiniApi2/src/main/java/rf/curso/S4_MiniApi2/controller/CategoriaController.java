...
//		String jdbcPassword = getServletContext().getInitParameter("jdbcPassword");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "register":
				...
				break;
			/*
			 * case "mostrar": obtener(request, response); break;
			 * 
			 * // case "showedit": showEditar(request, response); break;
			 * 
			 * case "editar": editar(request, response); break; case "eliminar":
			 * eliminar(request, response); break; default: break;
			 */ }
	...
	public Categoria montaModelo(HttpServletRequest request, HttpServletResponse response) {
		return new Categoria(0, request.getParameter("cat_nombre"), request.getParameter("cat_descripcion"));
	}

	public String guardar(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException, SQLException {
	...
	public List<Categoria> obtenerCategorias(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException, SQLException {
